...
import { IGatePosition } from '../../interfaces/exchanges/gate.exchange.interfaces';
...
export class GateExchangeService extends FuturesExchangeService {
  constructor() {
    super(ExchangeId.Gate);
  }

  fetchPositions = async (
    instance: Exchange
  ): Promise<IGatePosition[]> => await instance.fetchPositions();
